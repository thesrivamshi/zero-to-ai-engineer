...
<p>You're learning to build AI — so you should also learn to build <em>with</em> AI. Beyond chat, there are now <strong>agentic coding tools</strong> that live in your terminal, read your whole codebase, edit files, run commands, and use tools (including [[mcp|MCP]] servers) to complete real engineering tasks. [[claude code|Claude Code]] is the prominent one; Cursor, Aider, and others share the idea. They're agents (the loop you just learned) pointed at software.</p>
